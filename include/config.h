 ...
 * @Date: 2025-06-14 15:00:33
 * @LastEditors: aurson jassimxiong@gmail.com
 * @LastEditTime: 2025-06-14 17:01:30
 * @Description:
...
public:
    ...
    ResCode init(const std::string &config_path)
    {
        try
        {
            ...
            m_log_path = config_json["log"]["path"];
            m_log_size = config_json["log"]["size"];
            m_log_rotate = config_json["log"]["rotate"];
            m_log_level = config_json["log"]["level"];
